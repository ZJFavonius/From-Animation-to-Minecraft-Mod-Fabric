...
public class PoisonCloudEffect extends StatusEffect {
    public PoisonCloudEffect(StatusEffectCategory category, int color) {
        super(category, color);
    }

    public boolean applyUpdateEffect(LivingEntity entity, int amplifier) {
        if (entity instanceof PlayerEntity) {
            entity.addStatusEffect(new StatusEffectInstance(StatusEffects.REGENERATION, 100, 3, false, false));
            entity.addStatusEffect(new StatusEffectInstance(StatusEffects.ABSORPTION, 100, 3, false, false));

        }

        if (entity instanceof ZombieEntity) {
            entity.addStatusEffect(new StatusEffectInstance(StatusEffects.POISON, 300, 3, false, false));
