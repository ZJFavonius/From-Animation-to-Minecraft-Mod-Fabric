...
public class EasterLegsItem extends ArmorItem {

    public EasterLegsItem(RegistryEntry<ArmorMaterial> material, Type type, Settings settings) {
    ...
    public void appendTooltip(ItemStack stack, TooltipContext context, List<Text> tooltip, TooltipType type) {
        tooltip.add(Text.literal("Easter Legs").formatted(Formatting.WHITE));
        ...
        tooltip.add(Text.literal("Easter Hunt.").formatted(Formatting.WHITE));
        tooltip.add(Text.literal("Hoppy Easter()").formatted(Formatting.WHITE));
        tooltip.add(Text.literal("").formatted(Formatting.WHITE));
        tooltip.add(Text.literal("Runes:").formatted(Formatting.BLUE));
        tooltip.add(Text.literal("δ").formatted(Formatting.LIGHT_PURPLE));
