...
public class EasterBunHeadItem extends ArmorItem {

    public EasterBunHeadItem(RegistryEntry<ArmorMaterial> material, Type type, Settings settings) {
    ...
    public void appendTooltip(ItemStack stack, TooltipContext context, List<Text> tooltip, TooltipType type) {
        tooltip.add(Text.literal("Easter Bun Head").formatted(Formatting.WHITE));
