...
public class PghostItem extends ArmorItem {

    public PghostItem(RegistryEntry<ArmorMaterial> material, Type type, Settings settings) {
    ...
    public void appendTooltip(ItemStack stack, TooltipContext context, List<Text> tooltip, TooltipType type) {
        tooltip.add(Text.literal("Carved Pumpkin Cloth").formatted(Formatting.GOLD));
        ...
        tooltip.add(Text.literal("Trick or Treat or Threat").formatted(Formatting.GOLD));
        tooltip.add(Text.literal("Happy Halloween[*_*]").formatted(Formatting.GOLD));
        tooltip.add(Text.literal("").formatted(Formatting.WHITE));
        tooltip.add(Text.literal("Runes:").formatted(Formatting.BLUE));
        tooltip.add(Text.literal("Ṭ╫ŧ").formatted(Formatting.LIGHT_PURPLE));
