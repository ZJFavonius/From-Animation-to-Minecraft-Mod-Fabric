...
public class PostItem extends ArmorItem {

    public PostItem(RegistryEntry<ArmorMaterial> material, Type type, Settings settings) {
    ...
    public void appendTooltip(ItemStack stack, TooltipContext context, List<Text> tooltip, TooltipType type) {
        ...
        tooltip.add(Text.literal("₸ਠग").formatted(Formatting.LIGHT_PURPLE));
