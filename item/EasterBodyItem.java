...
public class EasterBodyItem extends ArmorItem {

    public EasterBodyItem(RegistryEntry<ArmorMaterial> material, Type type, Settings settings) {
    ...
    public void appendTooltip(ItemStack stack, TooltipContext context, List<Text> tooltip, TooltipType type) {
        tooltip.add(Text.literal("Easter Body").formatted(Formatting.WHITE));
