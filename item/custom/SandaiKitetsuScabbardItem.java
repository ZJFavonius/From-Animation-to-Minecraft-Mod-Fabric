...
public class SandaiKitetsuScabbardItem extends SwordItem {
    public SandaiKitetsuScabbardItem(ToolMaterials toolMaterials, Settings settings) {
    ...
    public TypedActionResult<ItemStack> use(World world, PlayerEntity user, Hand hand) {
        ...
        if (!world.isClient) {
            user.setStackInHand(hand, new ItemStack(ModItems.SANDAI_KITET));
            user.dropItem(ModItems.SANDAI_KITET_SAY);
