...
public class DemoniacVoltageReaverItem1 extends SwordItem {
    public DemoniacVoltageReaverItem1(ToolMaterials toolMaterials, int attackdamage, float attackSpeed, Settings settings) {
        super(CustomToolMaterial.DEMONIAC_VOLTAGE_REAVER, settings);
    ...
    public DemoniacVoltageReaverItem1(ToolMaterials toolMaterials, Settings settings) {
    ...
    public TypedActionResult<ItemStack> use(World world, PlayerEntity user, Hand hand) {
        ...
        try {
            if (!world.isClient) {
                if (itemStack.isOf(ModItems.DEMONIAC_VOLTAGE_REAVER1)) {
                    user.setStackInHand(hand, new ItemStack(ModItems.DEMONIAC_VOLTAGE_REAVER));
    ...
    public void appendTooltip(ItemStack stack, TooltipContext context, List<Text> tooltip, TooltipType type) {
        ...
        tooltip.add(Text.literal("1st Form").copy().formatted(Formatting.DARK_RED));
