...
public class CaptainCoatItem extends ArmorItem {

    public CaptainCoatItem(RegistryEntry<ArmorMaterial> material, Type type, Settings settings) {
    ...
    public void appendTooltip(ItemStack stack, TooltipContext context, List<Text> tooltip, TooltipType type) {
        tooltip.add(Text.literal("Luffy's Coat from Fishman Island").formatted(Formatting.RED));
