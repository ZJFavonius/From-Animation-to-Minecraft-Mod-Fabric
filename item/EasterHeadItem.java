...
public class EasterHeadItem extends ArmorItem {

    public EasterHeadItem(RegistryEntry<ArmorMaterial> material, Type type, Settings settings) {
    ...
    public void appendTooltip(ItemStack stack, TooltipContext context, List<Text> tooltip, TooltipType type) {
        tooltip.add(Text.literal("Easter Head").formatted(Formatting.WHITE));
