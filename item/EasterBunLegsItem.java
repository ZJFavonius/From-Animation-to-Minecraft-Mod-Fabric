...
public class EasterBunLegsItem extends ArmorItem {

    public EasterBunLegsItem(RegistryEntry<ArmorMaterial> material, Type type, Settings settings) {
    ...
    public void appendTooltip(ItemStack stack, TooltipContext context, List<Text> tooltip, TooltipType type) {
        tooltip.add(Text.literal("Easter Bun Legs").formatted(Formatting.WHITE));
