...
public class PgItem extends ArmorItem {

    public PgItem(RegistryEntry<ArmorMaterial> material, Type type, Settings settings) {
    ...
    public void appendTooltip(ItemStack stack, TooltipContext context, List<Text> tooltip, TooltipType type) {
        tooltip.add(Text.literal("Carved Pumpkin Head").formatted(Formatting.GOLD));
