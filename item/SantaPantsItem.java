...
public class SantaPantsItem extends ArmorItem {

    public SantaPantsItem(RegistryEntry<ArmorMaterial> material, Type type, Settings settings) {
    ...
    public void appendTooltip(ItemStack stack, TooltipContext context, List<Text> tooltip, TooltipType type) {
        tooltip.add(Text.literal("Santa Clause's Pants").formatted(Formatting.RED));
        ...
        tooltip.add(Text.literal("⚲╥").formatted(Formatting.LIGHT_PURPLE));
