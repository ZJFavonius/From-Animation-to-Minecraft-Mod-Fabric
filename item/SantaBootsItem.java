...
public class SantaBootsItem extends ArmorItem {

    public SantaBootsItem(RegistryEntry<ArmorMaterial> material, Type type, Settings settings) {
    ...
    public void appendTooltip(ItemStack stack, TooltipContext context, List<Text> tooltip, TooltipType type) {
        tooltip.add(Text.literal("Santa Clause's Boots").formatted(Formatting.RED));
        ...
        tooltip.add(Text.literal("⚲ն").formatted(Formatting.LIGHT_PURPLE));
