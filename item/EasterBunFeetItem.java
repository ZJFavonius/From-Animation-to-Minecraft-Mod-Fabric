...
public class EasterBunFeetItem extends ArmorItem {

    public EasterBunFeetItem(RegistryEntry<ArmorMaterial> material, Type type, Settings settings) {
    ...
    public void appendTooltip(ItemStack stack, TooltipContext context, List<Text> tooltip, TooltipType type) {
        tooltip.add(Text.literal("Easter Bun Feet").formatted(Formatting.WHITE));
