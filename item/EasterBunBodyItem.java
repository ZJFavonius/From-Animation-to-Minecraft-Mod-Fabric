...
public class EasterBunBodyItem extends ArmorItem {

    public EasterBunBodyItem(RegistryEntry<ArmorMaterial> material, Type type, Settings settings) {
    ...
    public void appendTooltip(ItemStack stack, TooltipContext context, List<Text> tooltip, TooltipType type) {
        tooltip.add(Text.literal("Easter Bun Body").formatted(Formatting.WHITE));
        ...
        tooltip.add(Text.literal("Easter.").formatted(Formatting.WHITE));
        tooltip.add(Text.literal("Hoppy Hunting()").formatted(Formatting.WHITE));
        tooltip.add(Text.literal("").formatted(Formatting.WHITE));
