...
public class SantaJacketItem extends ArmorItem {

    public SantaJacketItem(RegistryEntry<ArmorMaterial> material, Type type, Settings settings) {
    ...
    public void appendTooltip(ItemStack stack, TooltipContext context, List<Text> tooltip, TooltipType type) {
        tooltip.add(Text.literal("Santa Clause's Jacket").formatted(Formatting.RED));
        ...
        tooltip.add(Text.literal("Christmas Spirit.").formatted(Formatting.RED));
        tooltip.add(Text.literal("Merry Christmas[0_0]").formatted(Formatting.RED));
        tooltip.add(Text.literal("").formatted(Formatting.WHITE));
        tooltip.add(Text.literal("Runes:").formatted(Formatting.BLUE));
        tooltip.add(Text.literal("⚲ụ").formatted(Formatting.LIGHT_PURPLE));
