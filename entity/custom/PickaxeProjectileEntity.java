...
public class PickaxeProjectileEntity extends PersistentProjectileEntity {
    private float rotation;
    public Vector2f groundedOffset;

    public PickaxeProjectileEntity(EntityType<? extends PersistentProjectileEntity> pickaxeProjectileEntityEntityType, World world) {
        super(pickaxeProjectileEntityEntityType, world);
    }

    public PickaxeProjectileEntity(World world, PlayerEntity player) {
        super(ModEntities.PICKAXE_PROJECTILE, player, world, new ItemStack(ModItems.PICKAXE_PROJECTILE), (ItemStack)null);
    }

    protected ItemStack asItemStack() {
        return new ItemStack(ModItems.PICKAXE_PROJECTILE);
    }
